  ...
  return (
    <FormWrapper>
      ...
      <Forma onSubmit={handleSubmit(handlerSubmit)}>
        ...
        {step === 2 && (
          <>
            {category.includes("Недвижимость") && (
              <Realty control={control} register={register} errors={errors} />
            )}
            {category.includes("Авто") && (
              <Auto control={control} register={register} errors={errors} />
            )}
            {category.includes("Услуги") && (
