        ...
        <Controller
          ...
          render={({ field }) => (
            <Select
              className="select"
              placeholder={""}
              options={selectOptionsAuto}
              {...field}
            />
          )}
        />
        {errors.brand && (
          <FieldError>{errors.brand.message?.toString()}</FieldError>
        )}
      </Field>
      <Field>
        ...
        />
        {errors.model && (
          <FieldError>{errors.model.message?.toString()}</FieldError>
        )}
      </Field>
      <Field>
        ...
        />
        {errors.year && (
          <FieldError>{errors.year.message?.toString()}</FieldError>
        )}
      </Field>
      <Field>
        <label htmlFor="mileage">Пробег</label>
        <input
          {...register("mileage", { required: "Введите пробег" })}
          type="number"
          id="mileage"
        />
        {errors.mileage && (
          <FieldError>{errors.mileage.message?.toString()}</FieldError>
        )}
      </Field>
    </>
  );
